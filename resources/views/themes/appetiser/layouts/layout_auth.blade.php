...
<html lang="en"> <head> <meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo asset( '/themes/appetiser/css/auth.css' ) ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo asset( '/themes/appetiser/css/clean.css' ) ?>" />
